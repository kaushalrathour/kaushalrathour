...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    name: 'Picklebay',
    description:
      'Hyperlocal marketplace with WebToNative architecture and custom JS bridges for native-like interactions. Instrumented Firebase Analytics and Crashlytics for funnel monitoring.',
    stack: [
      { name: 'React Native', logo: reactLogo },
      { name: 'JavaScript' },
    ],
